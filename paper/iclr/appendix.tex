...
17--19 & Runtime-backed recommendations, global wording gated on true-DDPM plus PushT, and reviewer-skepticism checklist. & Supported \\
\bottomrule
\end{tabular}
\end{table}
...
This is only a toy sampler. & Global wording requires true-DDPM and PushT rollout-metric gates; learned-lite and controlled tiers are supporting context. & \path{ideal_metrics_status.json}, Claims 13--19 \\
...
\end{verbatim}
The paper PDF is written to \texttt{paper/iclr/main.pdf} and copied to \texttt{paper/iclr/final/best of n diffusion policy-v3.pdf}. The build wrapper compiles with the official ICLR 2026 style proxy and fails if the page label immediately before references exceeds nine pages.
