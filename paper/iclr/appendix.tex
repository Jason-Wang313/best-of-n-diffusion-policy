...
\end{verbatim}
The paper PDF is written to \texttt{paper/iclr/main.pdf} and copied to \texttt{paper/iclr/final/best of n diffusion policy-v4.pdf}. The build wrapper compiles with the official ICLR 2026 style proxy and fails if the page label immediately before references exceeds nine pages.
