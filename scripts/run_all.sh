...
"${PY[@]}" scripts/run_with_src.py experiments/fetch_robotics_benchmark.py --seeds 1 2 3 4 --train-states 6 --train-candidates 4 --eval-episodes 3 --candidates 8 --horizon 14 --epochs 10 --diffusion-steps 16 --mc-trials 15 --k-values 1 8 --regimes fetch_aligned fetch_low_diversity fetch_high_temp_misaligned
